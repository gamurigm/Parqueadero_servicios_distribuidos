import { Controller, Get, Post, Body, Patch, Param, Delete, Put, Req, Headers } from '@nestjs/common';
...
export class UsuarioController {
  ...
  updatePassword(
    ...
    const newpassword = body?.newpassword ?? body?.newPassword ?? body?.password;
