...
exports.AuthModule = AuthModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (configService) => {
                    let publicKey = configService.get('JWT_SECRET', 'super-secret-key-change-in-production');
                    try {
        ...
        exports: [jwt_1.JwtModule, passport_1.PassportModule, jwt_strategy_1.JwtStrategy, jwt_auth_guard_1.JwtAuthGuard],
    })
], AuthModule);
